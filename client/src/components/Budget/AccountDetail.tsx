        ...
        <Grid columns={16} style={{padding: "1rem"}}>
            ...
            <Grid.Column mobile={16} tablet={8} computer={8}>
                <Segment>
                    ...
                    <UpcomingTransactions transactions={props.account.upcomingTransactions} onPaidTransaction={onPaidTransaction} onDeleteTransaction={onDeleteTransaction} detail={true} accountInfo={null} />
                </Segment>
            </Grid.Column>
        </Grid>
    );
